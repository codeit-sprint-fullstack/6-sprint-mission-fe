...
import likeButton from "@/assets/likebt.png";
import dislikeButton from "@/assets/dislikebt.png";
import Image from "next/image";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { fetchProduct, toggleProductLike } from "@/api/Product/Product";
...
export default function LikeButton({ id, type, favoriteCount }: Props) {
