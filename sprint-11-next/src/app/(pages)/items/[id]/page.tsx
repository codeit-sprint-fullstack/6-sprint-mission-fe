...
import { deleteProducts, fetchProduct } from "@/api/Product/Product";
import { getProductComent, postProductComent } from "@/api/comment/comments";
...
export default function ItemsDetailPage() {
  ...
  const commentQueryKey = ["itemsComent", id] as const;

  const postComent = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
