...
export default function BoardDetail() {
  ...
  const fetchCommentsAgain = async (): Promise<void> => {
    const newComments = await fetchCommentsByArticleId(Number(id));
  ...
  useEffect(() => {
    const load = async (): Promise<void> => {
      try {
        const fetchedPost = await fetchArticleById(Number(id));
        const fetchedComments = await fetchCommentsByArticleId(Number(id));
