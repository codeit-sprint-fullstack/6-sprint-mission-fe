// src/app/items/[itemId]/edit/page.jsx
"use client";
...
export default function EditProductPage() {
  ...
  const {
    ...
    handleSubmit,
    constants,
  } = useProductForm(itemId); // 훅 사용 (itemId 전달)

  if (isLoading) {
    return (
      <div className="w-[1200px] max-w-full mx-auto p-8 flex justify-center items-center min-h-[400px]">
      ...
      >
        <div className="flex justify-between items-center w-full mb-6 flex-shrink-0">
          ...
          <button
            ...
            className="w-auto px-4 h-[42px] flex items-center justify-center bg-blue-500 text-gray-100 text-base leading-[26px] font-semibold border-none rounded-lg cursor-pointer transition-colors duration-300 ease-in-out hover:enabled:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
