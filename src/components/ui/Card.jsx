...
import articleDefaultImg from "@/app/assets/images/img-article-placeholder.svg";
import profileIcon from "@/app/assets/icons/ic-profile.svg";
      ...
      <div className="bg-secondary-25 w-full h-full pb-6 rounded-[8px] border-b-1 border-gray-200 flex item-center justify-center relative">
        <div className="flex flex-col w-full h-full gap-4">
          <div className="flex items-start justify-between gap-10">
            <h1 className="font-semibold text-lg text-secondary-800">
              {title}
            </h1>
